  ...
  return (
    ...
    viewport={{once:true}}>
        ...
        <div className='flex flex-col gap-5 md:gap-14 md:flex-row items-center'>
          ...
          <div>
            <h2 className='text-3xl justify-center font-medium max-w-lg mb-10 '> Introducing the AI-Powered Text to Image Generators</h2>
            <p className='text-gray-600 gap-5 mb-4'>
            ...
            <p className='text-gray-600 gap-5 '>
