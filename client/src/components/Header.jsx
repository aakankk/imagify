...
const Header = () => {
  ...
  return (
    ...
    viewport={{ once: true }}>
        ...
        <motion.h1 className='text-4xl max-w-[300px] am:text-7xl sm:max-w-[590px] mx-auto mt-10 text-center'
        initial={{ opacity: 0}}
        animate={{ opacity: 1}}
        transition={{ delay:0.4, duration: 2 }}>
            Turn text to <span className='text-blue-600'>image</span>, in seconds.
        </motion.h1>
        <motion.p className='text-center max-w-xl mx-auto mt-4'
        initial={{ opacity: 0, y: 20}}
        ...
        <motion.button onClick={onClickHandler} className='sm:text-lg bg-black text-white w-auto px-12 py-2.5 rounded-full mt-8 flex items-center gap-2'
        initial={{ opacity: 0}}
        animate={{ opacity: 1}}
